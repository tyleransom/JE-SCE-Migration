...
log using "SCE_mobility_refb_full_intvws_noSepC4_p01_SepDec_indiv.log", replace
...
* combine all data and estimate joint model  
use `m31a', clear
append using `m31b'
append using `m31c'
append using `m31d'
...
*codebook scuid if maxwave!=minwave
...
* estimate individual-level models
global suffix = "_refb_full_intvws_no_sepC4_p01_SepDec_indiv"

include indivestimation_inclDec
